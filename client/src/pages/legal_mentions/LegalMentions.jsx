        ...
        <div className={styles.container}>
          ...
          <section className={styles.section}>
            <h2 className={styles.subtitle}>
              Propriétaire du site : Wild Code School
            </h2>
            <p className={styles.text}>
              ...
              INNOV’EDUC), vous devez lire attentivement les présentes
              Conditions Générales d’Utilisation et de Services, car elles
              contiennent d’importantes informations et stipulations, relatives
              à vos obligations, droits et recours.
            </p>
            <p className={styles.text}>
              Les présentes Conditions Générales d’Utilisation et de Services
              (ci-après les « Conditions Générales ») des sites
              wildcodeschool.com et odyssey.wildcodeschool.com (ci-après le «
              Site ») sont éditées par la société INNOV’EDUC (ci-après la «
              Société »), société par actions simplifiées au capital social de
              14 250 €, dont le siège social est situé au 44 rue Alphonse
              Penaud, 75020 Paris (RCS Chartres 794 926 063), société éditrice
              du site wildcodeschool.com, dont le numéro de TVA
              intracommunautaire est FR 27 794 926 063. Organisme de formation
              enregistré auprès du Préfet de la région Centre le 23 juin 2014
              sous le n° 24 28 0154228.
            </p>
          </section>

          <section className={styles.section}>
            <h2 className={styles.subtitle}>Hébergement du site :</h2>
          ...
          <section className={styles.section}>
            ...
            <p className={styles.text}>
              Les images, illustrations, photographies utilisées sur ce site
              sont protégées par des droits de propriété intellectuelle. Toute
              ...
              pas de notre propre rédaction sont accompagnés de la mention de
              leur source ou de l'autorisation de l'auteur.
            </p>
          </section>
          ...
          <section className={styles.section}>
            ...
            <p className={styles.text}>
              Base juridique du traitement de données : [Consentement,
              Obligation légale, Exécution d’un contrat, etc.]
            </p>
            <p className={styles.text}>
              Finalité des données collectées : Les données d’identification
              (nom ; prénom ; adresse email personnelle et professionnelle ;
              numéro de téléphone ; âge ; ville ; adresse ip)
            </p>
            <p className={styles.text}>
          ...
          <section className={styles.section}>
            ...
            <p className={styles.text}>
              ...
              et régissent les relations contractuelles entre Cretchom et ses
              clients.
            </p>
          </section>
          ...
          <section className={styles.section}>
            ...
            <p className={styles.text}>
              ...
              vous pouvez nous contacter par email à contact@wildcodeschool.fr
              ou par courrier au Innov'Educ, à l’attention de service Protection
              des Données, 18 rue de la Gare, 28240, La Loupe.
            </p>
          </section>
